...
global.dfail = (type, m, conn) => {
    let msg = {
        rowner: '*[ ⚠️ تـحـذيـر ⚠️ ] هذا الامر لمالك البوت فقط*',
        owner: '*[ ⚠️ تـحـذيـر ⚠️ ] هذا الامر لمالك البوت فقط*',
        ...
        group: '*[ ⚠️ تـحـذيـر ⚠️ ] هذا الامر للجروبات فقط ليس هنا*',
        private: '*[ ⚠️ 𝐀𝐋𝐄𝐑𝐓𝐀 ⚠️ ] 𝙴𝚂𝚃𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 𝚂𝙾𝙻𝙾 𝙿𝚄𝙴𝙳𝙴 𝚂𝙴𝚁 𝚄𝚃𝙸𝙻𝙸𝚉𝙰𝙳𝙾 𝙴𝙽 𝙲𝙷𝙰𝚃 𝙿𝚁𝙸𝚅𝙰𝙳𝙾 𝙳𝙴𝙻 𝙱𝙾𝚃*',
        admin: '*[ ⚠️ تـحـذيـر ⚠️ ] هذا الامر لي مشرفين الجروب فقط ايها العضو*',
        botAdmin: '*[ ⚠️ تـحـذيـر ⚠️ ] يجب وضع البوت مشرف لي تنفيذ الامر*',
    ...
    let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: msg, contextInfo: { externalAdReply: { title: '˼‏❄˹ 𝙶𝙷𝙾𝚃𝙸-𝙱𝙾𝚃╿↶', body: '𝗼𝘄𝗻𝗲𝗿 𝗻𝘂𝗺𝗯𝗲𝗿', thumbnail: imagen1, sourceUrl: 'http://wa.me/201050861664' }}}}, aa)
