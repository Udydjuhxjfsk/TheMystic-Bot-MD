...
if (!img) throw '*『❍↜╎سوي ريبلاي للصوره الي تريد تحطها صوره المجموعه』*'
await conn.updateProfilePicture(m.chat, img).then(_ => m.reply('*❐┇تـم الـتـغـيـر ✅❯*'))
} else throw '*『❍↜╎سوي ريبلاي للصوره الي تريد تحطها صوره المجموعه』*'}
handler.command = /^تغيرالصورة?|تغيرالصوره$/i
handler.group = true
handler.admin = true
