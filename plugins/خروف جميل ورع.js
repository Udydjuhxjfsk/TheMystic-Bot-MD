...
handler.help = ['ورع', 'اهبل', 'خروف', 'جميل', 'غباء', 'ذكاء', 'manco', 'manca', 'rata', 'prostituta', 'prostituto'].map(v => v + ' @tag | nombre')
handler.tags = ['calculator']
handler.command = /^ورع|اهبل|خروف|جميل|غباء|ذكاء|manco|manca|rata|prostituta|prostituto/i
